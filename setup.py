...
setup(name='arlo',
      ...
      install_requires=['catboost==1.2', 'cloudpickle==1.6.0', 'gym==0.22.0', 'joblib==1.1.0', 'matplotlib==3.5.0',
                        'mushroom_rl==1.7.0', 'numpy==1.22.0', 'optuna==2.10.0', 'plotly==5.4.0', 'scikit_learn==1.0.2', 
                        'scipy==1.7.3', 'torch==2.1.0', 'xgboost==2.0.0', 'mujoco-py==2.1.2.14', 'cython==0.29.21'],
